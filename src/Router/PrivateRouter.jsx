    ...
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="bg-white p-6 rounded-lg shadow-xl text-center max-w-sm mx-auto">
          ...
          <p className="text-gray-600 mb-5">You must log in to access this page.</p>
          <div className="flex justify-center gap-4">
            ...
            <button
              onClick={() => navigate("/login", { state: location.pathname, replace: true })}
              className="btn btn-secondary text-white rounded-md hover:bg-secondary/90"
            >
              Go to Login
            </button>
          </div>
