                        ...
                        <div className="rounded-xl border border-gray-200 p-5">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="font-medium mt-1">{order?.firstName} {order?.lastName}</p>
                                </div>
                        ...
                        <div className="rounded-xl border border-gray-200 p-5 h-full">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <span className="text-sm text-gray-500">
                                    {order?.trackingHistory?.length || 0} updates
                                </span>
                            </div>
                                    ...
                                    {order?.trackingHistory?.map((entry, index) => (
                                        <div key={index} className="relative">
                                            ...
                                            <div className={`absolute left-0 md:left-4 transform -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full border-4 border-white ${
                                                ...
                                                (entry?.orderStatus === 'Approved' || entry?.orderStatus === "Order Placed") ? 'bg-yellow-500' :
                                                'bg-purple-500'
                                            }`}></div>
