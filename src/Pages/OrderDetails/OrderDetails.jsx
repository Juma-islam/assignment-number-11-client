            ...
            <div className="bg-white p-6 shadow rounded-lg">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center md:items-start mb-4">
                    ...
                    <div className="space-y-4 mt-3 md:mt-0 md:ml-6 md:w-2/3">
                        ...
                        <p><strong>Total Order Price:</strong> ${orderPrice}</p>
                        <p><strong>Status:</strong>
                            <span className={`px-2 py-1 text-sm font-semibold rounded ${status === 'Pending' ? 'bg-yellow-100 text-yellow-700' : status === 'Approved' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                                {status}
                            </span>
                        </p>
                        <p><strong>Payment Method:</strong> {paymentMethod}</p>
                        <p><strong>Payment Status:</strong>
                            <span className={`px-2 py-1 text-sm font-semibold rounded ${paymentStatus === 'Pending' ? 'bg-yellow-100 text-yellow-700' : 'bg-green-100 text-green-700'}`}>
                                {paymentStatus}
                            </span>
                        </p>
