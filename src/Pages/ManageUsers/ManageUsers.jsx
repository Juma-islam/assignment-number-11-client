    ...
    <div className="p-4 md:p-8 min-h-screen">
            ...
            <div key={user._id} className="bg-white shadow rounded-lg p-4 border border-gray-100">
              <div className="flex justify-between items-start mb-3">
                <div className="flex items-center">
                  <img src={user.photoURL} alt="User Profile" className="w-10 h-10 rounded-full object-cover mr-4" />
                  <div>
                ...
                <div className="flex flex-col items-end">
                  <span className="text-xs px-2 py-1 rounded bg-gray-100">{user.role}</span>
              ...
              <button onClick={() => openModal(user)} className="btn btn-primary w-full text-white">
                Update
              </button>
            </div>
          ))
              ...
              users.map((user) => (
                <tr key={user._id} className="border-b">
                  ...
                  <td className="p-3 text-center">
                    <button onClick={() => openModal(user)} className="btn btn-primary text-white">
                      Update
                    </button>
                  </td>
                </tr>
      ...
      <dialog ref={modalRef} className="modal">
        <div className="modal-box relative">
          <button onClick={() => modalRef.current.close()} className="btn btn-sm btn-circle absolute right-2 top-2">
            ✕
          </button>
            ...
            <>
              ...
              <div className="mt-4 space-y-3 text-sm">
                <p>
                  ...
                  <span className="px-2 py-1 bg-gray-100 rounded text-gray-700">{selectedUser.role}</span>
                </p>
              ...
              {showSuspendBox && (
                <div className="mt-5 animate-fadeIn">
                  <label className="font-semibold block mb-2">Reason for suspension</label>
