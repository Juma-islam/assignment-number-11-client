...
//                       <td>
//                         <div>
//                           <div className="font-semibold text-primary">{order.productTitle}</div>
...
//                           <div className="text-sm text-gray-500">Unit: ${order.productPrice}</div>
        ...
        <div className="card bg-base-100 shadow-md mb-6">
          <div className="card-body p-4 md:p-6 flex flex-col md:flex-row gap-4">
            ...
            <div className="dropdown dropdown-end">
              ...
              >
                {["all", "Pending", "Approved", "Delivered", "Rejected"].map(
                  (status) => (
                    <li key={status}>
                      <button
                        onClick={() =>
